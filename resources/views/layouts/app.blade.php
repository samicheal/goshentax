				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav " id="">
							...
							<li><a href="single.html">Tax News</a></li>
							...
							<li role="presentation" class="dropdown">
								...
								<ul class="dropdown-menu">
								  <li><a href="sub.html">Resource 1</a></li>
								  <li><a href="sub.html">Resource 2</a></li>
						...
						<ul class="rslides" id="slider3">
							<li>
								<div class="banner-info-slider">
									...
									<h3>Latest News</h3>
									<p>News news news.
										<span>By more text and still about hte news.</span></p>
									<div class="more">
							...
							<li>
									<div class="banner-info-slider">
										...
										<h3>Second News</h3>
										<p>Demo news news.
											<span>By demo demo text and still about news.</span></p>
										<div class="more">
											<a href="single.html" class="type-1">
												<span> Read More </span>
												<span> Read More </span>
							...
							<ul>
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html">Tax payment since 2016</a></h4>
										<h5>By <a href="#">Moby 47</a> <label>|</label> <i>30.03.2016</i></h5>
								...
								<li>
									...
									<div class="news-grid-right1">
										...
										<h5>By <a href="#">Mr Sam</a> <label>|</label> <i>30.03.2016</i></h5>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
								...
								<li>
									...
									<div class="news-grid-right1">
										<h4><a href="single.html">Group D was too hard for Nigeria</a></h4>
										<h5>By <a href="#">Mr Segun</a> <label>|</label> <i>30.03.2016</i></h5>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									</div>
									<div class="clearfix"> </div>
								</li>
