...
@section('title' , 'goshentax/legislation/create')
...
<!--//banner-->
 	...
 	<div class="grid-form">
        ...
        <h4 id="forms-horizontal">Add Legislation</h4>
        ...
        <form class="form-horizontal" id="legislate" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="file" id="image" name="policy" required>
            </div>	
          </div>
          
          <div class="form-group">
            <label for="content" class="col-sm-2 control-hor-form">Preamble</label>
            <div class="col-sm-10"><textarea name="contents" id="summernote" class="form-control" placeholder='description' required></textarea></div>
          </div>
